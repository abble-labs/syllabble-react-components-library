...
const DEFAULT_INPUT_STYLE = {
    className: 'appearance-none peer-checked:bg-light-800 w-5 h-5 border-[1px] rounded-full border-light-400 flex items-center text-white justify-center text-xs',
    style: {}
}

export default function RadioField({ name, value, inputStyle = DEFAULT_INPUT_STYLE, label, labelStyle = DEFAULT_LABEL_STYLE, onChange, required = false, touched, errors }) {
